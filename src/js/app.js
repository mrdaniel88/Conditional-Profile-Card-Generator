    ...
    variables.country != null ? variables.country : "Country"
          ...
          <ul class=${
            ...
            <li><a href="https://twitter.com/${
              variables.twitter != null ? variables.twitter : "4Geeks"
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github != null ? variables.github : "4Geeks"
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${
              variables.linkedin != null ? variables.linkedin : "4Geeks"
            }"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram != null ? variables.instagram : "4Geeks"
